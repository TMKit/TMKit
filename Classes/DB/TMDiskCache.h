 ...
 */
typedef void (^TMDiskCacheObjectBlock)(TMDiskCache *cache, NSString *key, id <NSCoding>  _Nullable object);

/**
 A callback block which provides the key and fileURL of the object
 */
typedef void (^TMDiskCacheFileURLBlock)(NSString *key, NSURL * _Nullable fileURL);
 ...
 */
typedef void (^TMDiskCacheFileURLEnumerationBlock)(NSString *key, NSURL * _Nullable fileURL, BOOL *stop);

/**
 A callback block which provides a BOOL value as argument
 */
typedef void (^TMDiskCacheContainsBlock)(BOOL containsObject);
 ...
 */
typedef NSData* _Nonnull(^TMDiskCacheSerializerBlock)(id<NSCoding> object, NSString *key);
 ...
 */
typedef id<NSCoding> _Nonnull(^TMDiskCacheDeserializerBlock)(NSData* data, NSString *key);
 ...
 *  @return encoded key
 */
typedef NSString *_Nonnull(^TMDiskCacheKeyEncoderBlock)(NSString *decodedKey);
 ...
 *  @return decoded key
 */
typedef NSString *_Nonnull(^TMDiskCacheKeyDecoderBlock)(NSString *encodedKey);
...
@interface TMDiskCache : NSObject <TMCaching>
 ...
 */
@property (nullable, copy) TMDiskCacheObjectBlock willAddObjectBlock;

/**
 A block to be executed just before an object is removed from the cache. The queue waits during execution.
 */
@property (nullable, copy) TMDiskCacheObjectBlock willRemoveObjectBlock;
 ...
 */
@property (class, readonly, strong) TMDiskCache *sharedCache;
...
- (instancetype)initWithName:(nonnull NSString *)name
                  ...
                  serializer:(nullable TMDiskCacheSerializerBlock)serializer
                deserializer:(nullable TMDiskCacheDeserializerBlock)deserializer
                  keyEncoder:(nullable TMDiskCacheKeyEncoderBlock)keyEncoder
                  keyDecoder:(nullable TMDiskCacheKeyDecoderBlock)keyDecoder
              operationQueue:(nonnull  TMOperationQueue *)operationQueue NS_DESIGNATED_INITIALIZER;
 ...
 */
- (void)objectForKeyAsync:(NSString *)key completion:(nullable TMDiskCacheObjectBlock)block;
 ...
 */
- (void)setObjectAsync:(id <NSCoding>)object forKey:(NSString *)key completion:(nullable TMDiskCacheObjectBlock)block;
 ...
 */
- (void)removeObjectForKeyAsync:(NSString *)key completion:(nullable TMDiskCacheObjectBlock)block;
 ...
 */
- (void)trimToSizeAsync:(NSUInteger)byteCount completion:(nullable TMCacheBlock)block;
...
/**
 ...
 @param block A block to be executed serially after the cache has been trimmed, or nil.
 */
- (void)trimToSizeByDateAsync:(NSUInteger)byteCount completion:(nullable TMCacheBlock)block;
 ...
 */
- (void)enumerateObjectsWithBlockAsync:(TMDiskCacheFileURLEnumerationBlock)block completionBlock:(nullable TMCacheBlock)completionBlock;
...
/**
 ...
 @param block A block to be executed when a lock is available.
 */
- (void)synchronouslyLockFileAccessWhileExecutingBlock:(TM_NOESCAPE TMCacheBlock)block;
 ...
 */
- (void)enumerateObjectsWithBlock:(TM_NOESCAPE TMDiskCacheFileURLEnumerationBlock)block;
